...
function AllMusic() {
  ...
  async function search() {
    ...
    if (artistId) {
      ...
      // Correct endpoint and proper query string construction
      let albums = await fetch('https://api.spotify.com/v1/artists/' + artistId + '/albums?include_groups=album&market=US&limit=20', searchParam)
        .then(response => response.json())
        .then(data => {
          console.log(data);
        })
